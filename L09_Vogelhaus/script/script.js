...
(function (L09_Vogelhaus) {
    ...
    function handleLoad(_event) {
        ...
        let posSnowflakes = new L09_Vogelhaus.Vector(400, 175);
    ...
    function drawSnowflakes(_nFlakes, _position) {
        ...
        for (let drawn = 0; drawn < _nFlakes; drawn++) {
            ...
            let snowflake = new L09_Vogelhaus.Snowflakes(pos, size);
            snowflake.drawSnowflakes();
    ...
    //     let particleSize: Vector1 = { x: 500, y: 100 };
    //     let leafSize: Vector1 = { x: 40, y: 100 };
    ...
    //     let birdSize: Vector1 = { x: 300, y: 50 };
    ...
    //     let birdSize: Vector1 = { x: 280, y: 0 };
    //     let birdDirection: number[] = [1, -1];
